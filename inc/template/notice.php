<div class='notice notice-warning' id='sbp-news' style="padding-top: 7px">
	...
	<p><?php printf( __( 'Check out the %1$s Plugin settings %2$s for new features that can make your site load faster.', 'sb-pack' ), '<a href="admin.php?page=sbp-options">', '</a>' ); ?></p>
</div>
<script>
